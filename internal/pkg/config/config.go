...
func Load() (*Config, error) {
	...
	c.OpenAI.Model = getEnv("ONGRID_OPENAI_MODEL", "gpt-4o")
	...
	c.LLM.Anthropic.Model = getEnv("ONGRID_ANTHROPIC_MODEL", "claude-3-5-sonnet-latest")
	c.LLM.Anthropic.BaseURL = getEnv("ONGRID_ANTHROPIC_BASE_URL", "")
	c.LLM.Anthropic.Models = splitProviderModels(getEnv("ONGRID_ANTHROPIC_MODELS", "claude-3-5-sonnet-latest,claude-3-opus-latest"))
	c.LLM.Zhipu.APIKey = getEnv("ONGRID_ZHIPU_API_KEY", "")
	c.LLM.Zhipu.Model = getEnv("ONGRID_ZHIPU_MODEL", "glm-4-plus")
	c.LLM.Zhipu.BaseURL = getEnv("ONGRID_ZHIPU_BASE_URL", "")
	c.LLM.Zhipu.Models = splitProviderModels(getEnv("ONGRID_ZHIPU_MODELS", "glm-4-plus,glm-4-air"))
	c.LLM.Gemini.APIKey = getEnv("ONGRID_GEMINI_API_KEY", "")
	c.LLM.Gemini.Model = getEnv("ONGRID_GEMINI_MODEL", "gemini-1.5-pro")
	c.LLM.Gemini.BaseURL = getEnv("ONGRID_GEMINI_BASE_URL", "")
	c.LLM.Gemini.Models = splitProviderModels(getEnv("ONGRID_GEMINI_MODELS", "gemini-1.5-pro,gemini-1.5-flash"))
	c.LLM.DeepSeek.APIKey = getEnv("ONGRID_DEEPSEEK_API_KEY", "")
	c.LLM.DeepSeek.Model = getEnv("ONGRID_DEEPSEEK_MODEL", "deepseek-chat")
	c.LLM.DeepSeek.BaseURL = getEnv("ONGRID_DEEPSEEK_BASE_URL", "")
	c.LLM.DeepSeek.Models = splitProviderModels(getEnv("ONGRID_DEEPSEEK_MODELS", "deepseek-chat,deepseek-reasoner"))
	c.LLM.Kimi.APIKey = getEnv("ONGRID_KIMI_API_KEY", "")
	c.LLM.Kimi.Model = getEnv("ONGRID_KIMI_MODEL", "moonshot-v1-8k")
	c.LLM.Kimi.BaseURL = getEnv("ONGRID_KIMI_BASE_URL", "")
	c.LLM.Kimi.Models = splitProviderModels(getEnv("ONGRID_KIMI_MODELS", "moonshot-v1-8k,moonshot-v1-32k,moonshot-v1-128k"))
